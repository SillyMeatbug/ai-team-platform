...
export function ProjectCard({ project, onQuickDelete, deleting = false }: ProjectCardProps) {
  ...
  return (
    <Card className="group relative bg-card border-border hover:border-primary/50 hover:glow-accent transition-all duration-200 cursor-pointer h-full overflow-hidden rounded-xl">
      <Link
